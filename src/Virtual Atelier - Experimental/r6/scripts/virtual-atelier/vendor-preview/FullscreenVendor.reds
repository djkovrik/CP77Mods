...
private func InitialzieAtelierSystems() -> Void {
  this.m_storesManager = VirtualAtelierStoresSystem.GetInstance(this.GetPlayerControlledObject().GetGame());
  this.m_previewManager = VirtualAtelierPreviewManager.GetInstance(this.GetPlayerControlledObject().GetGame());
}
