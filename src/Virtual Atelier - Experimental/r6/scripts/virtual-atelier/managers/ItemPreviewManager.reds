...
public class VirtualAtelierPreviewManager extends ScriptableSystem {
  ...
  public static func GetInstance(gi: GameInstance) -> ref<VirtualAtelierPreviewManager> {
    let system: ref<VirtualAtelierPreviewManager> = GameInstance.GetScriptableSystemsContainer(gi).Get(n"VendorPreview.ItemPreviewManager.VirtualAtelierPreviewManager") as VirtualAtelierPreviewManager;
    return system;
  }
