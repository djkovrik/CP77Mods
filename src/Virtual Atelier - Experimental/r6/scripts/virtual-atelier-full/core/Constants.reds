...
public class VendorPreviewButtonHint {
  ...
  public static func Get(playerPuppet: ref<GameObject>) -> ref<VendorPreviewButtonHint> {
    ...
    vendorPreviewButtonHint.previewModeToggleEnableLabel = AtelierTexts.PreviewEnable();
    vendorPreviewButtonHint.previewModeToggleDisableLabel = AtelierTexts.PreviewDisable();
    vendorPreviewButtonHint.previewModeTogglePurchaseLabel = GetLocalizedTextByKey(n"UI-ScriptExports-Buy0");
    vendorPreviewButtonHint.resetGarmentLabel = AtelierTexts.PreviewReset();
    vendorPreviewButtonHint.removeAllGarmentLabel = AtelierTexts.PreviewRemoveAllGarment();
    vendorPreviewButtonHint.removePreviewGarmentLabel = AtelierTexts.PreviewRemovePreviewGarment();
