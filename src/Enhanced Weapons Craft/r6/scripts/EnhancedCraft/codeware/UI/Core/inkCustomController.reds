// -----------------------------------------------------------------------------
// EnhancedCraft.Codeware.UI.inkCustomController
// -----------------------------------------------------------------------------
//
	...
	protected func SetRootWidget(rootWidget: ref<inkWidget>) -> Void {
		...
		if IsDefined(this.m_rootWidget) {
			if !IsDefined(this.m_rootWidget.GetController()) {
				...
				if NotEquals(this.GetControllerByType(this.GetClassName()), this.m_rootWidget.GetControllerByType(this.GetClassName())) {
