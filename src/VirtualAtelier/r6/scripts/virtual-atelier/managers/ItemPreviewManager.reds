...
public class VirtualAtelierPreviewManager extends ScriptableSystem {
  ...
  public static func GetInstance(player: ref<GameObject>) -> ref<VirtualAtelierPreviewManager> {
    let system: ref<VirtualAtelierPreviewManager> = GameInstance.GetScriptableSystemsContainer(player.GetGame()).Get(n"VendorPreview.ItemPreviewManager.VirtualAtelierPreviewManager") as VirtualAtelierPreviewManager;
    return system;
  }
