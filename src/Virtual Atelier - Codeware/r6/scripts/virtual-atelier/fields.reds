...
@addField(WebPage) public let navigationButtonPrev: wref<AtelierTextButton>;
@addField(WebPage) public let navigationButtonNext: wref<AtelierTextButton>;
@addField(WebPage) public let navigationLabel: wref<AtelierTextButton>;
@addField(WebPage) public let rootAtelierPanel: wref<inkVerticalPanel>;
