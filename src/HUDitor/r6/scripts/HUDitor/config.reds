...
public class HUDitorConfig {
  ...
  @runtimeProperty("ModSettings.description", "Mod-HUDitor-Toggles-Desc")
  public let autoDriveEnabled: Bool = true;
  ...
  @runtimeProperty("ModSettings.description", "Mod-HUDitor-Toggles-Desc")
  public let crystalCoatEnabled: Bool = true;
  ...
  @runtimeProperty("ModSettings.description", "Mod-HUDitor-Toggles-Desc")
  public let vehicleRadioEnabled: Bool = true;
  ...
  @runtimeProperty("ModSettings.description", "Mod-HUDitor-Toggles-Desc")
  public let vehicleHotkeyEnabled: Bool = true;
