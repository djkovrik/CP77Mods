...
public class TeleportDestinationHelper {
  ...
  private func PopulateDistrictsData() -> Void {
    ...
    downtown.coords = [
      Vector4(-2032.205078, 669.650024, 10.342606, 1.0),
      Vector4(-2022.895386, 498.522583, 9.949997, 1.0)
    ];
    ...
    glen.coords = [
      Vector4(-1609.206543, -1210.161621, 24.747269, 1.0),
      Vector4(-1603.516479, -1317.780518, 38.519920, 1.0)
    ];
    ...
    kabuki.coords = [
      Vector4(-1017.837891, 1544.031250, 0.529869, 1.0),
      Vector4(-831.619507, 1911.959595, 35.659103, 1.0),
      Vector4(-1191.495117, 1252.922729, 17.390549, 1.0)
    ];
    ...
    wellsprings.coords = [
      Vector4(-2354.901855, -1165.460815, 1.493042, 1.0),
      Vector4(-2490.846680, -1060.975952, 0.175583, 1.0)
    ];
    ...
    coast.coords = [
      Vector4(-1968.451904, -1663.577637, 3.290024, 1.0),
      Vector4(-2185.085693, -1941.897461, 6.915680, 1.0),
      Vector4(-2235.793701, -2214.437988, 11.647858, 1.0),
      Vector4(-2067.569580, -1767.490967, 2.241234, 1.0)
    ];
    ...
    westWind.coords = [
      Vector4(-2740.440430, -2410.323975, 7.528984, 1.0),
      Vector4(-2854.782959, -2388.929688, 5.057793, 1.0)
    ];
    ...
    arroyo.coords = [
      Vector4(127.458481, -720.647705, 7.349251, 1.0),
      Vector4(-625.327515, -1315.032349, 7.558945, 1.0),
      Vector4(-816.726685, -1352.448242, 7.709442, 1.0)
    ];
    ...
    littleChina.coords = [
      Vector4(-1739.493774, 1214.428101, 18.234169, 1.0)
    ];
