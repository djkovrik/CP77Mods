...
public class FirstEquipRandomizerConfig {
  public static func PercentageProbability() -> Int32 = 50    // <- configure here
}

public static func ShouldRunFirstEquip() -> Bool {
