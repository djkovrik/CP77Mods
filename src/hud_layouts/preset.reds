...
public let CustomBottomLeftHorizontal: ref<inkHorizontalPanel>;

@addMethod(inkGameController)
public func CreateCustomSlots() -> Void {
  this.CustomBottomLeftHorizontal = this.MakeHorizontalSlot(
    n"CustomBottomLeftHorizontal",
  ...
  this.CustomBottomLeftHorizontal.Reparent(this.RootSlot);
}
...
public func AdjustWidgetsPositions() -> Void {
  ...
  // this.minimapRef.Reparent(this.CustomBottomLeftHorizontal);

  // this.wantedBarRef.Reparent(this.BottomCenterSlot);

  // this.BottomRightHorizontalSlot.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  ...
  this.BottomRightHorizontalSlot.Reparent(this.CustomBottomLeftHorizontal);

  // let x = this.ammoCounterRef.GetController().GetRootCompoundWidget().GetWidget(n"ammo_counter_and_the_holder/ammo_counter/weapon_wrapper") as inkWidget;
...
private func SetWidgetsAppearance() -> Void {
  ...
  this.weaponPanel_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  this.damageIndicator_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  this.ammoWrapper_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  this.weaponHolder_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  this.weaponIcon_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
  this.weaponName_CHL.SetMargin(new inkMargin(0.0, 0.0, 0.0, 0.0));
}
